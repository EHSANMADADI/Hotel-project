...
import MenuOfCetring from "./MenuOfCetring";
    ...
    <>
      <div className="w-full h-screen relative z-50">
        ...
        <Image
          ...
          height={1500}
        />
          <div className="w-full absolute inset-0 z-10 flex  flex-col text-white">
          <MenuOfCetring />
        </div>
          ...
          <div className="flex border rounded-md border-gray-100 mt-5 p-5 items-center w-11/12 mx-auto justify-between md:mt-20 md:w-full md:p-1">
            ...
            >
              ...
              <input
                ...
                value={searchItem}
                type="text"
                className="border-none pb-5 pt-5   bg-transparent font-bold rounded-lg text-white text-right sm:text-center text-xl focus:outline-none "
            ...
            <div className="flex">
              <button
                className="font-bold p-3 md:p-2 bg-transparent border border-blue-500 text-white rounded-md hover:bg-slate-200 hover:text-blue-500 transition-all"
                onClick={() => {
                  return setTypeFood("old-food");
                }}
              >
                غذای صنتی
              </button>
              <button
                className="font-bold md:p-2 p-3 bg-transparent border border-blue-500 text-white rounded-md mx-5  hover:bg-slate-200 hover:text-blue-500 transition-all"
                onClick={() => {
                  return setTypeFood("fast-food");
                }}
              >
                {" "}
                فست فوود
